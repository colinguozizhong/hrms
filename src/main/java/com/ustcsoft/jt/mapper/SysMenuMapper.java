...
public interface SysMenuMapper {
	...
	List<SysMenuVO> selectPurviewMenuAll(@Param("userId") String userId);
	...
	void insertSysObj(@Param("sysObj") SysObjVO sysObj);

	List<SysMenuVO> selectSysMenusList();

	SysObjVO querySysObj(@Param("node") String node);

	void updateSysObj(@Param("sysObj")SysObjVO sysObj);

	void deleteSysObj(@Param("node") String node);
