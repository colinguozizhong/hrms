...
public class SystemController {
	...
	@RequestMapping("system/viewRAnnouncement.do")
	public String viewRAnnouncement() {
		logger.info("system/viewRAnnouncement.do");
		return "system/resiveAnnouncementManage";
	}
